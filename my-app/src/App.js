    ...
    <>
      ...
      <aside className="sidebar">
        <nav className="side-nav" aria-label="Primary">
          ...
          <h3>Travel Tips</h3>
          <a href="#packing">Packing Guide</a>
      ...
      <main className="content">
        <section className="hero">
          <div className="hero-text">
            ...
            <p>
              Inspiring travel guides, tips, and curated destinations for your
              next adventure.
            </p>
            <div className="cta-row">
              <a className="btn primary" href="#destinations">
                Discover Destinations
              </a>
              <a className="btn ghost" href="#europe">
                Start with Europe
              </a>
            </div>
          </div>
          <div className="hero-card">
            ...
            />
            <a className="btn slim" href="#europe">
              View More → 
            </a>
          </div>
        </section>
        ...
        <section id="destinations" className="grid">
          ...
          <div className="cards">
            {[
              {
                title: "Paris, France",
                desc: "The city of lights, romance, and world-famous landmarks.",
                link: "#europe",
              },
              {
                title: "Kyoto, Japan",
                desc: "Ancient temples, cherry blossoms, and tea ceremonies.",
                link: "#asia",
              },
              {
                title: "New York, USA",
                desc: "Skyscrapers, Broadway shows, and vibrant culture.",
                link: "#america",
              },
              {
                title: "Cape Town, South Africa",
                desc: "Breathtaking mountains, beaches, and wildlife.",
                link: "#africa",
              },
              {
                title: "Sydney, Australia",
                desc: "Opera House, beaches, and coastal walks.",
                link: "#oceania",
              },
              {
                title: "Rome, Italy",
                desc: "Historic ruins, art, and mouthwatering cuisine.",
                link: "#europe",
              },
            ].map((item, idx) => (
        ...
        <section id="europe" className="lesson">
          ...
          <div className="two-col">
            ...
            <div className="tip">
              <strong>Tip:</strong> Visit in spring or fall to avoid peak tourist crowds.
            </div>
          </div>
        </section>
        ...
        <section id="asia" className="lesson">
          ...
          <div className="two-col">
            ...
            <div className="note">
              <strong>Note:</strong> Research visa requirements before traveling.
            </div>
          </div>
        </section>
        ...
        <section id="packing" className="lesson">
          <h2>Packing Guide</h2>
          <ul className="bullets">
            <li>Lightweight clothing for layering</li>
        ...
        <footer className="site-footer">
          <p>
            © <span id="year">2025</span> GlobeTrek. Travel smart, travel far.
          </p>
